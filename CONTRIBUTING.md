...
- Preserve mode menu formatting: standalone plain text, one required empty line between option blocks, bare skill names, and the reply instruction after the options.
